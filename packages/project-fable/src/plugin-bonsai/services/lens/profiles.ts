import { type Account, type AccountManaged, evmAddress } from '@lens-protocol/client';
import { fetchAccount, fetchAccountsAvailable } from '@lens-protocol/client/actions';
import { client } from './client';

export const getProfileById = async (legacyProfileId: string): Promise<Account | undefined> => {
...
export const getProfilesOwned = async (ownedBy: `0x${string}`): Promise<AccountManaged[]> => {
