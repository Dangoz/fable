...
export const formatMetadata = (
  params: PostParams
): TextOnlyMetadata | ImageMetadata | VideoMetadata => {
  let attributes;
...
export const createPost = async (
  ...
  console.log('lens:: createPost:: failed to post with error:', result.error);
};
...
export const editPost = async (uri: string, metadata: any): Promise<boolean> => {
  try {
    ...
    console.log('lens:: ediPost:: failed to edit post with error:', error);
    return false;
  }
};
