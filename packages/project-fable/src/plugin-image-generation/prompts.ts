 ...
 */
export const DEFAULT_STYLE = 'futuristic with vibrant colors';

/**
 * Generates an image prompt input based on the user's text and style
 * @param content The user's message content
 * @param style The style to apply (defaults to DEFAULT_STYLE)
 * @returns A formatted prompt for the AI model
 */
export function generateImagePromptInput(content: string, style: string = DEFAULT_STYLE): string {
